...
class ScoreNet(nn.Module):
    ...
    def forward(self, batched_inputs: List[Dict[str, torch.Tensor]], combined_features):
        ...
        if "instances" in batched_inputs[0]:
            ...
            gt_instances = None
        lossIou, loss_segment, instances = self.roi_heads(combined_features, gt_instances, Ks, im_scales_ratio, images.image_sizes)
        ...
        return lossIou, loss_segment, instances
